        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-[#e5e5e5] pb-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href="https://wa.me/918447000200?text=Hello" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 mt-4 hover:text-[#25D366] transition-colors group">
              ...
              <span className="font-bold text-[13px] text-[#333] group-hover:text-[#25D366] transition-colors">Whatsapp</span>
            </a>
            ...
            <div className="mt-3">
              <Link to="/">
                <img src={logoImage} alt="Tobeque Logo" className="h-[20px] object-contain opacity-90 hover:opacity-100 transition-opacity" />
              </Link>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link to="/about-tobeque" className="text-[13px] text-[#555] hover:text-primary transition-colors">About Us</Link>
            <Link to="/blogs" className="text-[13px] text-[#555] hover:text-primary transition-colors">Blogs</Link>
