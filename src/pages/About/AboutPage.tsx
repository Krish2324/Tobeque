...
export function AboutPage() {
  ...
  useEffect(() => {
    const title = "About Tobeque | Teen Fashion Brand for Girls in India";
    const desc = "Learn about Tobeque, an Indian fashion brand creating stylish, comfortable clothing for teen girls with in-house design and manufacturing in Haryana, India.";
    const keywords = "about Tobeque, teen fashion brand India, fashion brand for teen girls, teenage girls clothing brand, girls fashion India, teen clothing brand, Tobeque Haryana";
