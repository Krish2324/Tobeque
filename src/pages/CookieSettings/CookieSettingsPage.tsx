...
export function CookieSettingsPage() {
  ...
  useEffect(() => {
    const title = "Cookie Settings | Manage Your Preferences | Tobeque";
    const desc = "Manage your cookie preferences on Tobeque. Review and update consent choices for essential, analytics and marketing cookies used across our website anytime.";
    const keywords = "Tobeque cookie settings, manage cookie preferences, cookie consent settings, analytics cookies, marketing cookies";
