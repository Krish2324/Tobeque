...
export function ProfilePage() {
  const { user, token, isAuthenticated, logout, openLoginModal } = useAuth();
  ...
  const initials = user.firstName
    ...
    : (user.phone ? user.phone.slice(-2) : 'TQ');
      ...
      <div className="pt-[72px] max-w-4xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="bg-white border border-outline-variant/60 p-8 md:p-12 mb-8 flex flex-col md:flex-row items-center md:items-start gap-8">
          ...
          <div className="flex-1 text-center md:text-left">
            <p className="text-[10px] text-gray-400 tracking-[0.25em] uppercase mb-2">Member Account</p>
        ...
        {activeTab === 'details' && (
          <div className="bg-white border border-outline-variant/60 p-8">
            <h2 className="font-serif text-xl text-[#111] mb-8">Account Details</h2>
            <div className="flex flex-col gap-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] text-gray-400 tracking-[0.2em] uppercase font-medium">Account Status</label>
                  <p className="text-sm text-[#111] py-3 border-b border-outline-variant/40 flex items-center gap-2">
              ...
              <div className="pt-4 border-t border-outline-variant/40">
                <p className="text-xs text-gray-400 leading-relaxed">
                  Your account was created using mobile OTP authentication. To update your profile details, please contact our support team.
                </p>
              </div>
            </div>
          </div>
